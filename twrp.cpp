...
#if (defined(SHRP_HUAWEI_SAR_FIX) && (defined(SHRP_NO_SAR_AUTOMOUNT) || !defined(BOARD_BUILD_SYSTEM_ROOT_IMAGE))) || (!defined(SHRP_HUAWEI_SAR_FIX) && (defined(SHRP_NO_SAR_AUTOMOUNT) && !defined(BOARD_BUILD_SYSTEM_ROOT_IMAGE)))
